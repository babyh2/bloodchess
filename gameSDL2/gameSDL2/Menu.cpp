...
int Menu::ShowMenu(SDL_Renderer *screen, TTF_Font *font)
{
    ...
    SDL_Event m_event;
    bool in_game = true;
    // Load background once for menu
    LoadMenu(screen, "menuchinh.png");
    while (in_game)
    {
        // Load background menu once (loaded before loop) and hiển thị
        Show(screen, 0, 0);
